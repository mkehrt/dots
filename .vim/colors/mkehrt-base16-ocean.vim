...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/mkehrt-base16-ocean.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "mkehrt-base16-ocean"
...
call <sid>hi("Boolean",      s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("Character",    s:gui0E, "", s:cterm0E, "", "", "")
call <sid>hi("Comment",      s:gui03, "", s:cterm03, "", "", "")
call <sid>hi("Conditional",  s:gui0B, "", s:cterm0B, "", "", "")
call <sid>hi("Constant",     s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("Define",       s:gui08, "", s:cterm08, "", "none", "")
call <sid>hi("Delimiter",    s:gui0F, "", s:cterm0F, "", "", "")
call <sid>hi("Float",        s:gui0E, "", s:cterm0E, "", "", "")
call <sid>hi("Function",     s:gui04, "", s:cterm04, "", "", "")
call <sid>hi("Identifier",   s:gui04, "", s:cterm04, "", "none", "")
call <sid>hi("Include",      s:gui08, "", s:cterm08, "", "", "")
...
call <sid>hi("SpecialChar",  s:gui0E, "", s:cterm0E, "", "", "")
call <sid>hi("Statement",    s:gui0B, "", s:cterm0B, "", "", "")
call <sid>hi("StorageClass", s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("String",       s:gui0C, "", s:cterm0C, "", "", "")
call <sid>hi("Structure",    s:gui0B, "", s:cterm0B, "", "", "")
call <sid>hi("Tag",          s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("Todo",         s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("Type",         s:gui0D, "", s:cterm0D, "", "none", "")
call <sid>hi("Typedef",      s:gui0B, "", s:cterm0B, "", "", "")
